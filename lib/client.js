window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".TN_I9W_wrap{align-items:center;gap:calc(10px * var(--pulse-scale-h,1));box-sizing:border-box;width:100%;max-width:calc(var(--dsh-composer-card-max-width,780px) * var(--pulse-scale-w,1));padding:calc(3px * var(--pulse-scale-h,1)) 14px;backdrop-filter:blur(14px)saturate(1.3);background:linear-gradient(#ffffffb8,#ffffff7a 60%,#ffffff9e),#ffffff8c;border:1px solid #0f172a14;border-radius:16px;margin:0 auto;display:flex;position:relative;box-shadow:0 6px 20px #0f172a14,inset 0 1px #ffffffd9}body[data-ds-dark-theme] .TN_I9W_wrap{background:linear-gradient(#ffffff14,#ffffff05 60%,#ffffff0d),#0d111b8c;border-color:#ffffff17;box-shadow:0 6px 20px #00000029,inset 0 1px #ffffff12}.TN_I9W_canvas{min-width:0;height:calc(30px * var(--pulse-scale-h,1));flex:auto;display:block}.TN_I9W_chips{max-height:calc(37px * min(var(--pulse-scale-h,1), 1));gap:calc(3px * min(var(--pulse-scale-h,1), 1)) calc(6px * min(var(--pulse-scale-h,1), 1));flex-flow:column wrap;flex:none;min-width:0;max-width:70%;display:flex;overflow:hidden}.TN_I9W_chip{align-items:center;gap:calc(4px * min(var(--pulse-scale-h,1), 1));padding:calc(1px * min(var(--pulse-scale-h,1), 1)) calc(7px * min(var(--pulse-scale-h,1), 1));font-size:calc(10px * min(var(--pulse-scale-h,1), 1));line-height:calc(13px * min(var(--pulse-scale-h,1), 1));white-space:nowrap;color:#0f172ac7;background:#ffffffb3;border:1px solid #0f172a14;border-radius:999px;display:inline-flex}body[data-ds-dark-theme] .TN_I9W_chip{color:#e2e8f0d9;background:#ffffff0f;border:1px solid #ffffff0f}.TN_I9W_dot{width:calc(5px * min(var(--pulse-scale-h,1), 1));height:calc(5px * min(var(--pulse-scale-h,1), 1));border-radius:50%;flex:none}.TN_I9W_resize{width:calc(32px * var(--pulse-scale-h,1));height:calc(30px * var(--pulse-scale-h,1));cursor:nesw-resize;position:absolute;top:0;right:0}.TN_I9W_dotOutput{background:#36dcf2}.TN_I9W_dotThinking{background:#9c6af0}.TN_I9W_dotTools{background:#f6ae31}.TN_I9W_dotTyping{background:#1ce386}.TN_I9W_dotNetwork{background:#25d07a}.TN_I9W_dotNetworkBad{background:#ef4f43}.TN_I9W_dotNetworkWarn{background:#f6ae31}.TN_I9W_dotStuck{background:#ef4f43}.TN_I9W_chipStuck{border-color:#ef4f4373;animation:1.2s ease-in-out infinite TN_I9W_pulse-stuck}@keyframes TN_I9W_pulse-stuck{0%,to{opacity:1}50%{opacity:.55}}@media (width<=640px){.TN_I9W_wrap{padding-left:10px;padding-right:10px}.TN_I9W_chips{max-width:55%}.TN_I9W_chipHideNarrow{display:none}}@media (prefers-reduced-motion:reduce){.TN_I9W_chipStuck{animation:none}}";
