window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".TN_I9W_wrap{align-items:center;gap:calc(10px * var(--pulse-scale,1));box-sizing:border-box;width:100%;max-width:var(--dsh-composer-card-max-width,780px);padding:calc(3px * var(--pulse-scale,1)) 14px;backdrop-filter:blur(14px)saturate(1.5);background:linear-gradient(#ffffff1a,#ffffff05 60%,#ffffff0f),#10141e80;border:1px solid #ffffff12;border-radius:16px;margin:0 auto;display:flex;position:relative;box-shadow:0 6px 20px #00000029,inset 0 1px #ffffff12}body[data-ds-dark-theme] .TN_I9W_wrap{background:linear-gradient(#ffffff14,#ffffff05 60%,#ffffff0d),#0d111b8c;border-color:#ffffff17}.TN_I9W_canvas{min-width:0;height:calc(30px * var(--pulse-scale,1));flex:auto;display:block}.TN_I9W_chips{max-height:calc(37px * var(--pulse-scale,1));gap:calc(3px * var(--pulse-scale,1)) calc(6px * var(--pulse-scale,1));flex-flow:column wrap;flex:none;max-width:70%;display:flex}.TN_I9W_chip{align-items:center;gap:calc(4px * var(--pulse-scale,1));padding:calc(1px * var(--pulse-scale,1)) calc(7px * var(--pulse-scale,1));font-size:calc(10px * var(--pulse-scale,1));line-height:calc(13px * var(--pulse-scale,1));white-space:nowrap;color:#e2e8f0d1;background:#ffffff12;border:1px solid #ffffff0f;border-radius:999px;display:inline-flex}body[data-ds-dark-theme] .TN_I9W_chip{color:#e2e8f0d9;background:#ffffff0f}.TN_I9W_dot{width:calc(5px * var(--pulse-scale,1));height:calc(5px * var(--pulse-scale,1));border-radius:50%;flex:none}.TN_I9W_resize{width:calc(26px * var(--pulse-scale,1));height:calc(15px * var(--pulse-scale,1));justify-content:flex-start;align-items:flex-end;gap:calc(2px * var(--pulse-scale,1));padding:calc(4px * var(--pulse-scale,1)) calc(5px * var(--pulse-scale,1)) 0 0;box-sizing:border-box;cursor:ns-resize;opacity:0;flex-direction:column;transition:opacity .15s;display:flex;position:absolute;top:0;right:0}.TN_I9W_wrap:hover .TN_I9W_resize,.TN_I9W_resize:focus-visible{opacity:.5}.TN_I9W_handleDot{width:calc(3px * var(--pulse-scale,1));height:calc(3px * var(--pulse-scale,1));color:#ffffffb3;background:currentColor;border-radius:50%}.TN_I9W_dotOutput{background:#36dcf2}.TN_I9W_dotThinking{background:#9c6af0}.TN_I9W_dotTools{background:#f6ae31}.TN_I9W_dotTyping{background:#1ce386}.TN_I9W_dotNetwork{background:#25d07a}.TN_I9W_dotNetworkBad{background:#ef4f43}.TN_I9W_dotNetworkWarn{background:#f6ae31}.TN_I9W_dotStuck{background:#ef4f43}.TN_I9W_chipStuck{border-color:#ef4f4373;animation:1.2s ease-in-out infinite TN_I9W_pulse-stuck}@keyframes TN_I9W_pulse-stuck{0%,to{opacity:1}50%{opacity:.55}}@media (width<=640px){.TN_I9W_wrap{padding-left:10px;padding-right:10px}.TN_I9W_chips{max-width:55%}.TN_I9W_chipHideNarrow{display:none}}@media (prefers-reduced-motion:reduce){.TN_I9W_chipStuck{animation:none}}";
		...
		*  the bar stays usable (and the chips never overwhelm the composer). */
		...
		function clampScale(value) {
			if (value < .6) return SCALE_MIN;
			if (value > 1.6) return SCALE_MAX;
			return value;
		}
		...
		const PulseBar = (0, react.memo)(function PulseBar({ session, input, connection, t }) {
			...
			const [scale, setScale] = (0, react.useState)(loadScale);
			const dragRef = (0, react.useRef)(null);
			(0, react.useEffect)(() => {
				try {
					localStorage.setItem("dsh-pulse:scale", String(scale));
				} catch {}
			}, [scale]);
			(0, react.useEffect)(() => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				"data-dsh-pulse": true,
				style: { "--pulse-scale": String(scale) },
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: PulseBar_module_css_default.handleDot }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: PulseBar_module_css_default.handleDot }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: PulseBar_module_css_default.handleDot })
						]
					})
