window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".TN_I9W_wrap{box-sizing:border-box;width:100%;max-width:var(--dsh-composer-card-max-width,780px);backdrop-filter:blur(14px)saturate(1.5);background:linear-gradient(#ffffff1a,#ffffff05 60%,#ffffff0f),#10141e80;border:1px solid #ffffff12;border-radius:16px;align-items:center;gap:10px;margin:0 auto;padding:3px 14px;display:flex;box-shadow:0 6px 20px #00000029,inset 0 1px #ffffff12}body[data-ds-dark-theme] .TN_I9W_wrap{background:linear-gradient(#ffffff14,#ffffff05 60%,#ffffff0d),#0d111b8c;border-color:#ffffff17}.TN_I9W_canvas{flex:auto;min-width:0;height:30px;display:block}.TN_I9W_chips{flex-flow:column wrap;flex:none;gap:3px 6px;max-width:70%;max-height:37px;display:flex}.TN_I9W_chip{white-space:nowrap;color:#e2e8f0d1;background:#ffffff12;border:1px solid #ffffff0f;border-radius:999px;align-items:center;gap:4px;padding:1px 7px;font-size:10px;line-height:13px;display:inline-flex}body[data-ds-dark-theme] .TN_I9W_chip{color:#e2e8f0d9;background:#ffffff0f}.TN_I9W_dot{border-radius:50%;flex:none;width:5px;height:5px}.TN_I9W_dotOutput{background:#36dcf2}.TN_I9W_dotThinking{background:#9c6af0}.TN_I9W_dotTools{background:#f6ae31}.TN_I9W_dotTyping{background:#1ce386}.TN_I9W_dotNetwork{background:#25d07a}.TN_I9W_dotNetworkBad{background:#ef4f43}.TN_I9W_dotNetworkWarn{background:#f6ae31}.TN_I9W_dotStuck{background:#ef4f43}.TN_I9W_chipStuck{border-color:#ef4f4373;animation:1.2s ease-in-out infinite TN_I9W_pulse-stuck}@keyframes TN_I9W_pulse-stuck{0%,to{opacity:1}50%{opacity:.55}}@media (width<=640px){.TN_I9W_wrap{padding-left:10px;padding-right:10px}.TN_I9W_chips{max-width:55%}.TN_I9W_chipHideNarrow{display:none}}@media (prefers-reduced-motion:reduce){.TN_I9W_chipStuck{animation:none}}";
